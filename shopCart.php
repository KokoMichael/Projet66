...
if(isset($_POST['delete_panier']))
    ...
    if(isset($_POST['update_quantity']))
    {
            ...
            $updateQuantity->execute(array($id_quantity));
                ...
                <div class="col-lg-4 offset-lg-2">
                    <div class="cart__total__procced">
                        ...
                        <ul>
                            ...
                            ?>
                            <li>Total HT <span><?= number_format($sous_total+= $calcul['prix'] * $calcul['quantity'],2); ?> FCFA</span></li>
                            <li>TVA <span><?= number_format( $tva = $sous_total*($taux_tva/100)) ?> FCFA</span></li>
                            <li>Total TTC <span><?= number_format($total = $sous_total+$tva) ?> FCFA</span></li>
                        </ul>
                        <?php
